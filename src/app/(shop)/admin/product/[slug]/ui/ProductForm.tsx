...
import { ProductImage as ImageProduct } from '@/components'
...
export const ProductForm = ({ product, categories }: Props) => {
  ...
  const onSubmit = async (data: FormInputs) => {
    ...
    if (!ok) {
      return alert('Producto no se pudo actualizar!!')
    }
          ...
          <div className='flex flex-wrap'>
            {sizes.map((size) => (
              ...
              <div
                ...
                key={size}
                className={clsx('p-2 border cursor-pointer rounded-md mr-2 mb-2 w-14 text-center transition-all', {
